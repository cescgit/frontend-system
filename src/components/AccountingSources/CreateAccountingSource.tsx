...
export default function CreateAccountingSource() {
    ...
    const [newAccountingSource, setNewAccountingSource] = useState({
        codigo: '',
        descripcion: '',
        usuario_creador: '',
        fecha_creacion: ''
    ...
    const { mutate } = useMutation({
        mutationFn: createAccountingSource,
        onError: (error) => {
            MySwal.fire({
                position: "center",
        ...
        onSuccess: (data) => {
            queryClient.invalidateQueries({ queryKey: ["accountingSources"] })
            MySwal.fire({
                position: "center",
    ...
    const {
        ...
        reset,
        formState: { errors },
    } = useForm<AccountingSourceFormDataAdd>({ defaultValues: newAccountingSource });
    ...
    const onSubmitCreateAccountAccounting = () => {
        ...
        newAccountingSource.usuario_creador = idUSerLogin;

        const data = newAccountingSource;
                        ...
                        >
                            <div className="w-full">
                                ...
                                <input
                                    ...
                                    placeholder="Coódigo de fuente contable..."
                                    id="codigo"
                                    value={newAccountingSource.codigo}
                                    onChange={(e) => {
                                        setNewAccountingSource({ ...newAccountingSource, codigo: e.target.value });
                                    }}
                                    minLength={5}
                                    maxLength={50}
                                />
                            ...
                            <div className="w-full">
                                ...
                                <input
                                    ...
                                    id="descripcion"
                                    value={newAccountingSource.descripcion}
                                    onChange={(e) => {
                                        setNewAccountingSource({ ...newAccountingSource, descripcion: e.target.value });
                                    }}
                                    minLength={5}
                                    maxLength={150}
                                />
