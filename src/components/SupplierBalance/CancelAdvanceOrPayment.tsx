...
import { cancelAdvanceOrPayment, getDetailsByBalanceSupplier } from "../../apis/SupplierBalanceAPI";
...
export default function CancelAdvanceOrPayment({ id, onClose }: CancelAdvanceOrpaymentBalanceProps) {
    const navigate = useNavigate()
    const location = useLocation()
    const queryParams = new URLSearchParams(location.search)
    const supplierBalanceId = queryParams.get("supplierBalance")!;
    let idUSerLogin;
    ...
    const { isError, data } = useQuery({
        queryKey: ["supplierBalance", supplierBalanceId],
        queryFn: () => getDetailsByBalanceSupplier({ id: supplierBalanceId }),
        enabled: !!supplierBalanceId,
        retry: false
    })
    ...
    const { mutate } = useMutation({
        mutationFn: cancelAdvanceOrPayment,
        onError: (error) => {
            MySwal.fire({
                position: "center",
        ...
        onSuccess: (data) => {
            ...
            queryClient.invalidateQueries({ queryKey: ["cancelAdvanceOrPaymentSupplierBalance"] })
    ...
    const onSubmitCancelAdvanceOrPayment = () => {
        ...
        const data = { supplierBalanceId, formData }        
