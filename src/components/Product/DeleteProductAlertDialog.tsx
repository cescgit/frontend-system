...
import { ProductFormDataDelete } from "../../types/productData";
...
export default function DeleteProductAlertDialog({ product, onClose }: { product: ProductFormDataDelete, onClose: () => void }) {
