...
type BoxInventoryProps = {
    onSelectionChange: (product: TempPurchasingFormData) => void;
    onStockChange: (stock: number) => void;
  };

export default function ProductsComboBoxInventory({ onSelectionChange, onStockChange }: BoxInventoryProps) {
        ...
        <>
            <Dialog.Root open={open} onOpenChange={setOpen}>
                ...
                <Dialog.Portal>
                    ...
                    <Dialog.Content className="w-[95%] h-lvh md:h-[95%] fixed left-1/2 top-1/2 overflow-y-auto scroll-smooth touch-pan-y overflow-scroll -translate-x-1/2 -translate-y-1/2 rounded-md bg-white p-[25px] shadow-[var(--shadow-6)] focus:outline-none data-[state=open]:animate-contentShow">
                        ...
                        <div className="mt-3 w-auto h-[25rem] md:h-[35rem] mx-auto">
                            <Table.Root variant="surface" className="overflow-x-auto h-full overflow-y-auto touch-pan-y touch-pan-x p-2 min-w-[1200px]">
