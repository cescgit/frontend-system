...
export default function ReportRemissionById({ remission }: { remission: Remissions }) {
  ...
  const downloadPdf = async () => {
    try {
      ...
      const response = await api(`remissions/reportRemissions/${remission.id}`, {
      ...
      link.download = `Remisión-${remission.codigo}-${remission.nombre_cliente}.pdf`; // Nombre del archivo a descargar
      link.click();
