...
export default function DetailsByIdCustomerBalanceModal({id}: {id: string}) {
    ...
    const balanceCustomerDetailsId = queryParams.get("viewBalanceCustomer")!;
    ...
    const { isError, data } = useQuery({
        queryKey: ["customerBalance", balanceCustomerDetailsId],
        queryFn: () => getDetailsByBalanceCustomer({ id: balanceCustomerDetailsId }),
        enabled: !!balanceCustomerDetailsId,
        retry: false
    })
            ...
            <Dialog.Portal>
                ...
                <Dialog.Content
                    ...
                    <Dialog.Title className="font-bold text-black text-2xl text-center">
                        Muestra información del anticipo o pago del cliente
                    </Dialog.Title>
                    <Dialog.Description className="my-2 text-base text-black text-center">
                        Aquí puedes ver la información del anticipo o pafo del cliente.
                    </Dialog.Description>
