...
export default function CreateUnitOfMeasure() {
    ...
    const {
        ...
        reset,
        formState: { errors },
    } = useForm<UnitOfMeasureFormDataAdd>({ defaultValues: newUnitOfMeasure });
    ...
    const onSubmitCreateBrand = () => {
        ...
        newUnitOfMeasure.usuario_creador = idUSerLogin;

        const data = newUnitOfMeasure;
                ...
                <Dialog.Portal>
                    ...
                    <Dialog.Content
                        ...
                        <Dialog.Description className="my-2 text-base text-black text-center">
                            Crea tus unidades de medida aquí...
                        </Dialog.Description>
                        <form
                        ...
                        >
                            <div className="w-full">
                                ...
                                <input
                                    ...
                                    id="unidad_medida"
                                    value={newUnitOfMeasure.unidad_medida}
                                    onChange={(e) => {
                                        setNewUnitOfMeasure({ ...newUnitOfMeasure, unidad_medida: e.target.value });
                                    }}
                                    minLength={2}
                                    maxLength={15}
                                />
                            ...
                            <div className="w-full">
                                ...
                                <input
                                    ...
                                    id="abreviatura"
                                    value={newUnitOfMeasure.abreviatura}
                                    onChange={(e) => {
                                        setNewUnitOfMeasure({ ...newUnitOfMeasure, abreviatura: e.target.value });
                                    }}
                                    minLength={1}
                                    maxLength={5}
                                />
