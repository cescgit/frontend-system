        ...
        <>
            <Dialog.Root open={open} onOpenChange={setOpen}>
                <Dialog.Trigger asChild>
                    <button
                        className="flex items-center justify-center transition-all duration-200 py-1 px-2 bg-slate-50/75 border border-gray-300 hover:bg-slate-100/65 rounded-md font-medium gap-x-2 w-full"
                    >
