...
interface ProductInventoryProps {
    product: TempPurchasingFormData,
    onClose: () => void
}

export default function DeleteProductInventorySeparatedProductAlertDialog({ product, onClose }: ProductInventoryProps) {
    ...
    const { mutate } = useMutation({
        mutationFn: deleteProductInInventorySeparatedproduct,
        onError: (error) => {
            MySwal.fire({
                position: "center",
                title: "Producto",
        ...
        onSuccess: (data) => {
            queryClient.invalidateQueries({ queryKey: ["sepratedProducts"] })
            MySwal.fire({
                position: "center",
                title: "Producto",
                icon: "success",
