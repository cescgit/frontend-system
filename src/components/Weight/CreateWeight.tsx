...
export default function CreateWeight() {
    ...
    const {
        ...
        reset,
        formState: { errors },
    } = useForm<WeightFormDataAdd>({ defaultValues: newWeight });


    const onSubmitCreateWeight = () => {
        const jwt = localStorage.getItem("tokenAccountingSystem")
        const decoded = jwtDecode<JWTData>(jwt!);
        idUSerLogin = decoded.id;
        newWeight.usuario_creador = idUSerLogin;
                ...
                <Dialog.Portal>
                    ...
                    <Dialog.Content
                        ...
                        <Dialog.Description className="my-2 text-base text-black text-center">
                            Crea el peso de los productos aquí...
                        </Dialog.Description>
                        <form
                            onSubmit={handleSubmit(onSubmitCreateWeight)}
                            className="space-y-3"
                        >
                            <div className="w-full">
                                ...
                                <input
                                    ...
                                    placeholder="El peso de los productos..."
                                    id="peso"
                                    value={newWeight.peso}
                                    onChange={(e) => {
                                        setNewWeight({ ...newWeight, peso: e.target.value });
                                    }}
                                    minLength={2}
                                    maxLength={15}
                                />
                            ...
                            <div className="w-full">
                                ...
                                <input
                                    ...
                                    id="abreviatura"
                                    value={newWeight.abreviatura}
                                    onChange={(e) => {
                                        setNewWeight({ ...newWeight, abreviatura: e.target.value });
                                    }}
                                    minLength={1}
                                    maxLength={5}
                                />
