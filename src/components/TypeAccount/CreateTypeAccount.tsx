...
import { createTypeAccount } from "../../apis/TypeAccountAPI";
import { TypeAccountFormDataAdd } from "../../types/typeAccontData";
import Swal from "sweetalert2";
import withReactContent from 'sweetalert2-react-content'

const MySwal = withReactContent(Swal);

export default function CreateTypeAccount() {
    ...
    const {
        ...
        reset,
        formState: { errors },
    } = useForm<TypeAccountFormDataAdd>({ defaultValues: newTypeAccount });
    ...
    const onSubmitCreateAccountAccounting = () => {
        ...
        newTypeAccount.usuario_creador = idUSerLogin;

        const data = newTypeAccount;
                    ...
                    <Dialog.Content
                        ...
                        >
                            <div className="w-full">
                                <label className="w-full text-left text-black font-bold" htmlFor="nombre">
                                    Tipo de cuenta
                                </label>
                                <input
                                    {...register("nombre", {
                                    ...
                                    id="nombre"
                                    value={newTypeAccount.nombre}
                                    onChange={(e) => {
                                        setNewTypeAccount({ ...newTypeAccount, nombre: e.target.value });
                                    }}
                                    minLength={5}
                                    maxLength={50}
                                />
                            ...
                            <div className="w-full">
                                ...
                                <input
                                    ...
                                    id="descripcion"
                                    value={newTypeAccount.descripcion}
                                    onChange={(e) => {
                                        setNewTypeAccount({ ...newTypeAccount, descripcion: e.target.value });
                                    }}
                                    minLength={5}
                                    maxLength={150}
                                />
